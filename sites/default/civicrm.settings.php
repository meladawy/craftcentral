...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://civicrm:civicrm@localhost/civicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm2:civicrm2@localhost/civicrm2?new_link=true');
  }
}
...
$civicrm_root = '/Users/magedahmed/Sites/civicrm/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/magedahmed/Sites/civicrm/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/~magedahmed/civicrm/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '195e73925eb9c0a0a0360426fc6db8ab');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/magedahmed/Sites/civicrm/sites/default/files/civicrm/templates_c//mail.log');
// }
